		...
		<Item>
			<Text>
				...
				<SecondaryText
					...
					>Pretty much the same phone, but a different brand name and OS. It spies on you more, too.</SecondaryText
				>
			</Text>
		</Item>
		<Item>
			<Text>
				...
				<SecondaryText
					...
					>A very weak phone that you can install literally anything on. Compile your own kernel,
					you nerd. :D</SecondaryText
				>
			</Text>
		</Item>
	</List>
